...
<?php
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		echo "<tr>" ;
		echo "<td>".$eq1."</td>" ;
		echo "<td><input type='text' name='score1' id='score1' value='".$score1."' size='1' maxlength='2'></td>" ;
		if($pou_eve_id==4) {
			echo "<td><input type='text' name='pen1' id='pen1' value='".$pen1."' size='1' maxlength='2'></td>" ;
		}
		echo "</tr>" ;
		echo "<tr>" ;
		echo "<td>".$eq2."</td>" ;
		echo "<td><input type='text' name='score2' id='score2' value='".$score2."' size='1' maxlength='2'></td>" ;
		if($pou_eve_id==4) {
			echo "<td><input type='text' name='pen2' id='pen2' value='".$pen2."' size='1' maxlength='2'></td>" ;
		}
		echo "</tr>" ;
		echo "<tr>" ;
		...
		echo "<tr>" ;
		echo "<td>Forfait ?</td>" ;
		echo "<td><select name='forfait' id='forfait'>".
...
?>
	<tr>
		<td colspan=2 align='center'>
			<?php echo boutonRetour() . " " . boutonSubmit("envScore", "Envoyer") ; ?>
		</td>
	</tr>
</table>
</CENTER>
