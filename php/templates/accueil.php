	...
	if(isAdmin() || isCapitaine()) { 
		...
		while ($rowEquipe = mysqli_fetch_array($resultEquipe)) {
			...
			echo "<tr id='equipe_' style='height: 27px'>" ;
				echo "<TD><a href='index.php?op=eq&id=".$eq_id."'>".$eq_nom."</a></TD>" ;
				echo "<TD>".$corresp."</TD>" ;
			echo "</TR>" ;
		}
	} else {
