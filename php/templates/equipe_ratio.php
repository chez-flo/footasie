			...
			<?php
				$sSQLClassement = "select eq_id, eq_nom, coalesce(sum(sco_points)-(select coalesce(sum(pen_point),0) from " . TBL_PENALITE . ", " . TBL_MATCH . " where pen_eq_id = eq_id and pen_mat_id = mat_id and mat_sai_annee = '" . SAISON . "' and pen_pou_id = pou_id),0) pts, " .
						...
						" where sco_eq_id = eq_id " .
							...
							" and pou_id ='" . $pou_id . "' " .
							" and eve_id = 2 " .
						" group by eq_nom order by ratio desc, pts desc, diff desc, bp desc, eq_nom " ;
							...
							<td align=center>
								<table class="tabDetail tabCalendrierEquipe" id="classement">
									...
									<TR id='classement_'>
										...
										<TH WIDTH=15 ALIGN=center>Ratio</TH>
									</TR>
									<?php echo $classement ; ?>
									<!--tr>
								...
								<table class="tabDetail" id="responsables">
									...
									<tr id='responsables_'>
										<td>
											...
											<?php
												$sSQLCapitaines = "select jou_nom, jou_mail, jou_tel from " . TBL_EQUIPE_CORRESP . ", " . TBL_JOUEUR . " where ec_jou_id = jou_id and ec_eq_id = " . $eq_page_id ;
											...
											?>
												...
												<tr style="height: 20px">
													<td colspan=3 align=center ><a href="index.php?op=ics&eq_id=<?php echo $eq_page_id ; ?>"><img src="<?php echo IMG ; ?>download_cal.png" alt="cal" height="20">T&eacute;l&eacute;charger le calendrier de l'ann&eacute;e</a></td>
												</tr>
											</TABLE>
										</td>
									</tr>
