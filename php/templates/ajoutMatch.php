...
<?php
	...
	$sSQLPoule = "SELECT pou_id, CONCAT(eve_nom, ' ', pou_nom) poule " .
		...
		" ORDER BY pou_id " ;
	//echo $sSQLPoule ;
	$resultPoule = mysql_query($sSQLPoule) ;
	echo "<tr>" ;
	...
	while ($rowPoule = mysql_fetch_array($resultPoule)) {
		extract($rowPoule) ;
...
?>
	...
	<tr>
		<td align='center'>
			<input type='button' name='retour' value='Retour' onclick='javascript:history.go(-1)'>&nbsp;
			<input type='submit' name='ajoutMatch' value='Valider'>
		</td>
	</tr>
</table>
</CENTER>
