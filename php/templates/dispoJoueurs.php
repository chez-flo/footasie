...
<script>
	function Valid_Form(form) {
		var liste = document.getElementById("invites[]");
		...
		<table colspan="3" align="center">
			<tr>
				<td class="center col200">
					<select id="joueurs[]" name="joueurs[]" onChange='effacerGroup(this.name);' multiple size="20" class="col200 bgRefuse">
						<?php echo createOptionsJoueurs(htmlentities($_GET['id'])) ; ?>
					</select>
				</td>
				<td class="center">
					<img src="<?php echo IMG ; ?>flecheD.png" name="inviter" value=">" onClick="copier('joueurs[]','invites[]')" width="90px" class="main"/><br/><br/>
					<img src="<?php echo IMG ; ?>flecheG.png" name="retirer" value="<" onClick="copier('invites[]','joueurs[]')" width="90px" class="main"/>
				</td>
				<td class="center col200">
					<select id="invites[]" name="invites[]" multiple size="20" class="col200 bgParticipe">
						<?php echo createOptionsInvites(htmlentities($_GET['id'])) ; ?>
					</select>
				</td>
			</tr>
			<tr>
		...
		<table align="center">
			<tr>
				<td colspan="2" align="center">
					<?php echo boutonRetour() . " " . boutonSubmit("invJoueurs", "Inviter les joueurs", 'return Valid_Form(document.forms["form"]);') ; ?>
				</td>
			</tr>
		</table>
	</Form>
